...
HD_PWD='/home/axel/Documents/Vivado/CoCiNum/MorseDecoder/MorseDecoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_decoder_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source morse_decoder_top.tcl
