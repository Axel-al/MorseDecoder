...
HD_PWD='/home/axel/Documents/Vivado/CoCiNum/MorseDecoder/MorseDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_decoder_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source morse_decoder_top.tcl -notrace
