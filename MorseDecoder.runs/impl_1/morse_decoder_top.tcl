...
set rc [catch {
  ...
  open_checkpoint morse_decoder_top_routed.dcp
  set_property webtalk.parent_dir /home/axel/Documents/Vivado/CoCiNum/MorseDecoder/MorseDecoder.cache/wt [current_project]
  catch { write_mem_info -force morse_decoder_top.mmi }
  write_bitstream -force morse_decoder_top.bit 
  catch {write_debug_probes -quiet -force morse_decoder_top}
  catch {file copy -force morse_decoder_top.ltx debug_nets.ltx}
