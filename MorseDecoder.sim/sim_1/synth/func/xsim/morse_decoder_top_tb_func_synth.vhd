...
-- Date        : Sat Jan 11 23:50:07 2025
-- Host        : axel-GL62M-7RDX running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               /home/axel/Documents/Vivado/CoCiNum/MorseDecoder/MorseDecoder.sim/sim_1/synth/func/xsim/morse_decoder_top_tb_func_synth.vhd
...
architecture STRUCTURE of ascii_to_display is
  ...
  signal \refresh_counter0_carry__3_n_2\ : STD_LOGIC;
  signal \refresh_counter0_carry__3_n_3\ : STD_LOGIC;
  ...
  signal \NLW_refresh_counter0_carry__3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_refresh_counter0_carry__3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \char_n_o_OBUF[0]_inst_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \char_n_o_OBUF[1]_inst_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \char_n_o_OBUF[2]_inst_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \char_n_o_OBUF[3]_inst_i_1\ : label is "soft_lutpair41";
...
\refresh_counter0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_refresh_counter0_carry__3_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \refresh_counter0_carry__3_n_2\,
      CO(0) => \refresh_counter0_carry__3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
architecture STRUCTURE of morse_to_binary is
  ...
  attribute SOFT_HLUTNM of \ascii_reg[0]_i_11\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \ascii_reg[0]_i_12\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \ascii_reg[1]_i_10\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \ascii_reg[1]_i_11\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ascii_reg[1]_i_12\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \ascii_reg[1]_i_5\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \ascii_reg[1]_i_9\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ascii_reg[2]_i_11\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \ascii_reg[2]_i_9\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ascii_reg[3]_i_13\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ascii_reg[3]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \ascii_reg[3]_i_9\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \ascii_reg[4]_i_11\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \ascii_reg[4]_i_12\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ascii_reg[4]_i_13\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \ascii_reg[4]_i_14\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \ascii_reg[4]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \ascii_reg[4]_i_9\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_13\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_14\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_15\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_20\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_21\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_24\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_26\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_27\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_28\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_30\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_33\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_36\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_38\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_40\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ascii_reg[6]_i_42\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \count[0]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \count[1]_i_11\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \count[1]_i_12\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \count[1]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \count[1]_i_6\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \count[2]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \count[2]_i_4\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \count[2]_i_6\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \count[4]_i_2\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \count[4]_i_9\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \morse[0]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \morse[0]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \morse[0]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \morse[0]_i_6\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \morse[16]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \morse[16]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \morse[3]_i_4\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \morse[4]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \morse[4]_i_3\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \morse[6]_i_2\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \morse[8]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \morse[9]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \zcount[1]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \zcount[1]_i_4\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \zcount[1]_i_6\ : label is "soft_lutpair26";
begin
